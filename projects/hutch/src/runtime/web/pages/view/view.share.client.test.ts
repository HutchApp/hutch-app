...
<span data-view-share-status></span>
<div data-view-share-wrap hidden>
  <button type="button" data-view-share-close></button>
  <button type="button" data-view-share data-share-url="${ARTICLE_URL}" data-share-title="${ARTICLE_TITLE}"></button>
  <span data-view-share-copied>Link copied!</span>
</div>
</body></html>`;
...
describe("initShareBalloon — attach/dismiss flow", () => {
	it("does not open after a scroll when the dismiss flag is already set", () => {
		...
		const wrap = element(document, "[data-view-share-wrap]");
		ctrl.attach();
...
describe("initShareBalloon — close button", () => {
	it("removes the open class and persists the dismiss flag in storage", () => {
		...
		fireEvent.click(element(document, "[data-view-share-close]"));
...
describe("initShareBalloon — share click", () => {
	it("copies the data-share-url to the clipboard and flashes the copied feedback", async () => {
		...
		const copiedLabel = element(document, "[data-view-share-copied]");
		const status = element(document, "[data-view-share-status]");
		ctrl.attach();

		fireEvent.click(element(document, "[data-view-share]"));
