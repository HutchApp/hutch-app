...
Most AI content features try to curate _for_ you. They pick what's interesting. They decide what you see next. That's the algorithmic feed model. It's the reason people use read-it-later apps: to escape the machine-curated timeline and read on their own terms.
...
Each TL;DR is two or three plain-text sentences about the article's core argument or finding. No markdown. No "5 Key Takeaways" header. No extracted quotes. Just a short description of what the piece says.
...
There's a minimum length check too. Articles shorter than about 800 visible characters skip the summary step. If the article is short enough to scan, a summary adds nothing.
