...
|-----|-------|-------------|-------------|-----------------|-----------|
| **Hutch** | A$3.99/mo | TL;DR summaries | Source-available (AGPL) | Planned | Web, Chrome, Firefox |
| **Readwise Reader** | $8.99-12.99/mo | Ghostreader AI | No | Yes | Web, iOS, Android, Chrome, Firefox, Safari |
...
| **Matter** | Free | AI co-reader | No | Yes | iOS, Android, Web |

## Hutch

I built Hutch after ten years of maintaining a personal reading system. Save an article with one click, read it later in a clean reader view, and get an AI-generated TL;DR for every piece. It runs on AWS in Sydney and operates under the Australian Privacy Act. The code is source-available under AGPL. Hutch is newer than most options here and still adding features. What it does today, it does well.
...
- Privacy-first: hosted in Australia, no tracking scripts, no third-party analytics. Data stays under Australian Privacy Act jurisdiction.
- Source-available (AGPL). You can read every line of code that handles your data.
...
**$12.99/month (or $8.99/month billed annually)**
...
Most of them do. Readwise Reader, Instapaper, and Raindrop.io all support Pocket import. Hutch supports importing from a Pocket export file. Karakeep and Wallabag have import tools too. Check each app's documentation for the current import process.
