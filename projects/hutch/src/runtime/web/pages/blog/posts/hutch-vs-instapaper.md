...
Readplace is browser-first. It's a web app with a browser extension, not a native mobile app. It works on any device with a browser, but it lacks the deep OS features a native app gives you. No share sheet on your phone. No offline reading on the train yet. If you need mobile apps, that's a real gap right now.
