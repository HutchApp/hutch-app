...
I built Readplace as a middle ground. A hosted read-it-later app with a clear revenue model: subscriptions. No investors. No exit to chase.
...
Pocket was abandoned. Omnivore disappeared. I turned that personal system into Readplace. One developer, building in public, one feature at a time.
...
I would rather be honest about gaps than pretend they don't exist. Features ship one at a time, and the [roadmap is public](https://readplace.com/#roadmap).

## Your data, your terms

**AGPL source-available.** The full source code is [on GitHub](https://github.com/Readplace/readplace). If Readplace disappears tomorrow, anyone can run it. That's the point.
...
**No venture capital.** Readplace is self-funded. Revenue comes from subscriptions. There are no investors expecting an exit, no board to please, no acquisition to chase.
...
[Install the browser extension](https://readplace.com/install) or [view the source on GitHub](https://github.com/Readplace/readplace).
