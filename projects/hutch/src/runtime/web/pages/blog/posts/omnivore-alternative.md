...
| Open source | Was (archived) | AGPL | Shipped |
...
| API access | Yes | OAuth only | Extension API exists |
| Self-hosting | Yes | No | Not planned yet |
...
**AGPL source-available.** The full source code is [on GitHub](https://github.com/HutchApp/hutch-app) under AGPL. If Hutch disappears tomorrow, anyone can run it. That's the point.
...
A$3.99/month. No tiers. No upsells. TL;DR summaries are included.
...
Hutch is free for the first 100 founding members. Full access, forever. After that, it costs A$3.99/month (about US$2.60). Self-hosted alternatives like Karakeep and Wallabag are free but require you to run your own server. Readwise Reader is the most feature-complete option at $12.99/month.

**Can I import my Omnivore data into Hutch?**

Not yet. Omnivore export import is on the roadmap. If you exported your data before the shutdown, keep that file. You can start fresh right now with the [browser extension](https://hutch-app.com/install). Save any article with one click.
