...
<p style="margin:0 0 24px;font-size:16px;line-height:1.6;color:${EMAIL_COLORS.body};">Click the button below to verify your email address and activate your Hutch account.</p>
...
<p style="margin:24px 0 0;font-size:14px;line-height:1.6;color:${EMAIL_COLORS.muted};">If you didn't create a Hutch account, you can ignore this email.</p>
</td></tr>
</table>
</td></tr>
</table>
