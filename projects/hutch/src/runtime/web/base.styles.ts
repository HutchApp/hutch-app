const LIGHT_THEME_VARIABLES: Record<string, string> = {
	...
	"--color-border": "#e5e0d8",
	"--color-brand": "#c8923c",
	"--color-brand-dark": "#b5832f",
	"--color-brand-light": "#faf3e8",
	"--color-success": "#22c55e",
	"--color-warning": "#f59e0b",
	"--color-error": "#ef4444",
	"--shadow-sm": "0 1px 2px rgba(0,0,0,0.05)",
	"--shadow-md": "0 4px 6px rgba(0,0,0,0.07)",
	"--primary": "hsl(37 56% 51%)",
	"--primary-foreground": "hsl(0 0% 100%)",
	"--secondary": "hsl(37 30% 95%)",
	"--secondary-foreground": "hsl(37 56% 35%)",
...
const DARK_THEME_VARIABLES: Record<string, string> = {
	...
	"--color-border": "#2e2e2e",
	"--color-brand": "#d4a04a",
	"--color-brand-dark": "#c8923c",
	"--color-brand-light": "#3d3018",
	"--color-success": "#34d669",
	"--color-warning": "#f5a623",
	"--color-error": "#f06060",
	"--shadow-sm": "0 1px 2px rgba(0,0,0,0.3)",
	"--shadow-md": "0 4px 6px rgba(0,0,0,0.4)",
	"--primary": "hsl(37 56% 56%)",
	"--secondary": "hsl(37 15% 18%)",
	"--secondary-foreground": "hsl(37 56% 70%)",
	"--accent": "hsl(37 56% 56%)",
	"--ring": "hsl(37 56% 56%)",
	"--ring-shadow": "hsl(37 56% 56% / 0.25)",
