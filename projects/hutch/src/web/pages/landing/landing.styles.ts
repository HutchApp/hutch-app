export const LANDING_PAGE_STYLES = `
  ...
  .landing-comparison__container {
    max-width: 900px;
    margin: 0 auto;
  }

  .landing-comparison__header {
    text-align: center;
    margin-bottom: 48px;
  }

  .landing-comparison__label {
    font-size: 0.8125rem;
    text-transform: uppercase;
    letter-spacing: 0.1em;
    color: var(--primary);
  ...
  /* Hide comparison table on mobile, show stacked cards instead */
