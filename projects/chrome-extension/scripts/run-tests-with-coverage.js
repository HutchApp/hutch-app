...
run('Chrome Extension - Running unit tests',
...
if (e2eUnitTests) {
  run('Chrome Extension - Running E2E unit tests', `node --test ${e2eUnitTests}`)
}

run('Chrome Extension - Building extension for E2E tests',
  'node scripts/build-extension.js',
  { HUTCH_SERVER_URL: 'http://127.0.0.1:3000' })

run('Chrome Extension - Running E2E tests',
  'node --test dist/e2e/login-flow/run.e2e-local.js',
  { HEADLESS: 'true' })

console.log('\n=== Chrome Extension - All tests completed successfully ===\n')
process.stdout.write('')
